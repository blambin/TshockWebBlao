	...
	<div class="panel-heading">
		<h3 class="panel-title">
			<a role="button" data-toggle="collapse" data-parent="commandpanel"
				aria-expanded="true" data-target="#commandbody">命令行</a>
		</h3>
	</div>
		...
		<div>
			...
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#command"
					aria-controls="command" role="tab" data-toggle="tab">命令行</a></li>
				<li role="presentation"><a href="#chat" aria-controls="chat"
					role="tab" data-toggle="tab">聊天</a></li>
					...
					<div class="panel-body ">
						...
						<div class="input-group">
							<span class="input-group-addon" id="sizing-addon3">#</span> <input
								...
								placeholder="在这里输入命令..以/开始"> <span
								class="input-group-btn">
								<button class="btn btn-default" type="button"
									id="chatboxmsgbutton">发送!</button>
								<button class="btn btn-default" type="button"
									id="chatboxmsgbuttonclear">清屏</button>
							</span>
						</div>
					</div>
				</div>
				<div role="tabpanel" class="tab-pane" id="chat">
					<div class="panel-body ">
						<div id="chatchatboxmsg" class="pre-scrollable inner-content">
							<span class="label label-warning chat-content">聊天功能需要
								Tshock安装 ExtraRestAdmin插件 .<a
